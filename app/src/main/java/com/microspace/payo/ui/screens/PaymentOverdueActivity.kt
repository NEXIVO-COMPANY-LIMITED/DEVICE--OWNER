...
class PaymentOverdueActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            Log.d(TAG, "â•‘ ðŸ’° PAYMENT OVERDUE ACTIVITY CREATED")
            ...
            Log.d(TAG, "ðŸ“± Screen: Payment Overdue")
            Log.d(TAG, "ðŸ”“ Unlock: Possible after payment")
    ...
    private fun handlePayNow() {
        try {
            Log.d(TAG, "ðŸ’³ Pay Now clicked")
            recordSuccess("PAY_NOW_CLICKED", "User initiated payment")
        } catch (e: Exception) {
            Log.e(TAG, "âŒ Error in handlePayNow: ${e.message}")
