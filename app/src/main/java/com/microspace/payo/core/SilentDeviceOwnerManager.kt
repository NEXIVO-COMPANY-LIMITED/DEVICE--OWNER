 ...
 *
 * All restrictions work SILENTLY â€“ no popups, no dialogs, no messages to user.
 * User hawezi kufanya blocked actions â€“ that's it. NO message inaonekana.
 *
...
class SilentDeviceOwnerManager(private val context: Context) {
    ...
    companion object {
        ...
        /**
         * All critical restrictions â€“ applied silently, no user messages.
    ...
    /**
     * Blocks factory reset silently. User tries â†’ nothing happens, no message.
     */
