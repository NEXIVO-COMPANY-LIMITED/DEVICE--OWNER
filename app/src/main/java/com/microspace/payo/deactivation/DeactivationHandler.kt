...
class DeactivationHandler(
            ...
            try {
                ...
                return@withContext when (result) {
                    ...
                    is DeactivationResult.Failure -> {
                        Log.e(TAG, "âŒ Deactivation failed: ${result.error}")
                ...
                Log.e(TAG, "âŒ Exception during deactivation handling: ${e.message}", e)
    ...
    private suspend fun sendConfirmationToServer(
        ...
        if (lastException != null) {
            Log.e(TAG, "âŒ Failed to send confirmation after $MAX_RETRY_ATTEMPTS attempts")
        }
    }
    ...
    fun applySoftLock(
        ...
        handlerScope.launch {
            try {
                ...
                Log.e(TAG, "âŒ Error applying soft lock: ${e.message}", e)
            }
        }
    }
    ...
    fun unlockDevice(
        ...
        handlerScope.launch {
            try {
                ...
                Log.e(TAG, "âŒ Error unlocking device: ${e.message}", e)
            }
        }
    }
