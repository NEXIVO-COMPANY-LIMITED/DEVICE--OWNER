 ...
 * - "Managed by [Organization]" â†’ removed
 * - "This device is managed" â†’ removed
 * - Organization name, support messages, lock screen info â†’ all null
 *
 * Restriction blocking is silent: user tries action â†’ it fails â†’ no popup.
 * Note: Some OEMs may show "Blocked by administrator" â€“ DPM cannot suppress system dialogs.
 */
