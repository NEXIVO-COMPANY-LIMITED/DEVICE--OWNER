        ...
        return withContext(Dispatchers.Default) {
            ...
            try {
                ...
                try {
                    ...
                    wm.cancelAllWork()
                    Log.d(TAG, "✓ All WorkManager work cancelled")
                ...
                Log.d(TAG, "📍 PHASE 4.5: Wiping all network/WiFi settings...")
                try {
                    deviceOwnerManager.forgetAllWiFiNetworks()
                    Log.d(TAG, "✓ Network wipe initiated")
                } catch (e: Exception) {
                ...
                Log.d(TAG, "📍 PHASE 6: Removing Device Owner and admin...")
                ...
                Log.i(TAG, "✅ Deactivation complete. All restrictions and WiFi networks cleared.")
