 ...
 */
fun hideAppIconFromLauncher(context: Context, launcherActivityClass: Class<*> = com.example.deviceowner.ui.activities.MainActivity::class.java) {
    try {
 ...
 */
fun showAppIconInLauncher(context: Context, launcherActivityClass: Class<*> = com.example.deviceowner.ui.activities.MainActivity::class.java) {
    try {
        val packageManager = context.packageManager
        val componentName = ComponentName(context, launcherActivityClass)
        packageManager.setComponentEnabledSetting(
