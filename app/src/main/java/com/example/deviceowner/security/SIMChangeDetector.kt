...
import com.example.deviceowner.data.local.database.entities.SimChangeHistoryEntity
...
class SIMChangeDetector(private val context: Context) {
    ...
    private fun showSIMChangeOverlay() {
        ...
        try {
            val intent = Intent(context, com.example.deviceowner.ui.activities.SIMChangeOverlayActivity::class.java).apply {
