...
class TamperDetector(private val context: Context) {
     ...
     * REMOVED: product, hardware, device, brand checks (not needed for detection)
     */
    ...
    /**
     * Check if device is tampered (any tampering detected)
     */
    fun isTampered(): Boolean {
        return getTamperStatus().isTampered
    }
