...
interface ApiService {
     ...
     * POST http://82.29.168.120/api/devices/{device_id}/data/
     * 
     * Sends heartbeat data and receives lock status from backend
     */
     ...
     * POST http://82.29.168.120/api/devices/{device_id}/manage/
     * 
     * Sends lock or unlock commands to backend
     */
