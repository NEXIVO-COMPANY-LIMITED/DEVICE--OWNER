...
class HeartbeatWorker(
    ...
    private suspend fun processHeartbeatResponse(deviceId: String, response: com.example.deviceowner.data.models.HeartbeatResponse) {
        withContext(Dispatchers.Main) {
            try {
                ...
                com.example.deviceowner.utils.SharedPreferencesManager(applicationContext).saveHeartbeatResponse(
     ...
     */
    private suspend fun handleDeactivationRequest(deviceId: String, response: com.example.deviceowner.data.models.HeartbeatResponse) {
        Log.i(TAG, "🔓 ═══════════════════════════════════════════════════════════")
        ...
        try {
            ...
            com.example.deviceowner.utils.SharedPreferencesManager(applicationContext).setHeartbeatEnabled(false)
     ...
     */
    private suspend fun handleDeviceLock(response: com.example.deviceowner.data.models.HeartbeatResponse) {
        Log.e(TAG, "🚨 ═══════════════════════════════════════════════════════════")
     ...
     */
    private suspend fun handlePaymentStatus(response: com.example.deviceowner.data.models.HeartbeatResponse) {
    ...
    private suspend fun queueForOfflineSync(request: HeartbeatRequest) {
        try {
            ...
            val event = com.example.deviceowner.data.local.database.entities.OfflineEvent(
                eventType = "HEARTBEAT",
                jsonData = json
            )
