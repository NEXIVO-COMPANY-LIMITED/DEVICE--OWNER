...
class LocalDataServerService : Service() {
    ...
    private suspend fun handleDeviceDataRequest(): ServerResponse {
        return try {
            val deviceCollector = com.example.deviceowner.services.DeviceDataCollector(this@LocalDataServerService)
    ...
    private suspend fun handleStatusRequest(): ServerResponse {
        return try {
            ...
            val prefsManager = com.example.deviceowner.utils.SharedPreferencesManager(this@LocalDataServerService)
