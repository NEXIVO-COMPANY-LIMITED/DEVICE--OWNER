...
Related: [Device Registration](05-device-registration.md), [Device Heartbeat](07-device-heartbeat.md), [Device Tamper](09-device-tamper.md), [Device Logs and Bugs](11-device-logs-and-bugs.md).
