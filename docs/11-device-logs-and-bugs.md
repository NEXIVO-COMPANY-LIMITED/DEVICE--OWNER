...
For **tamper** (which may be logged and reported), see [Device Tamper](09-device-tamper.md). For **folder layout** of the project, see [Folder Structure](14-folder-structure.md).
