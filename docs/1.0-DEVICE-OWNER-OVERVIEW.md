...
- Runs with **Device Owner** and **Device Admin** privileges so the app can apply system-level restrictions and survive user tampering within Androidâ€™s model.
...
|-------|----------------|
| **Device Owner / Device Admin** | `DeviceOwnerManager`, `SilentDeviceOwnerManager`, `AdminReceiver` â€” policy application, compatibility, silent restrictions |
| **Security & tamper** | `TamperBootChecker`, `EnhancedAntiTamperResponse`, `SIMChangeDetector`, `DeviceOwnerRemovalDetector`, `AccessibilityGuard` â€” detect and respond to tamper |
| **Monitoring & heartbeat** | `SecurityMonitorService`, `HeartbeatService`, `HeartbeatWorker` â€” foreground monitoring, 30s heartbeat, policy checks |
| **Lock control** | `RemoteDeviceControlManager`, `HardLockManager`, `SoftLockOverlayService` â€” soft lock overlay, hard lock (kiosk) |
| **Registration & data** | `DeviceRegistrationRepository`, `DeviceDataCollectionActivity`, `DeviceDataCollector` â€” loan number, device ID, data collection for backend |
| **Backend communication** | `ApiClient`, `ApiEndpoints`, interceptors â€” registration, heartbeat, tamper, logs, bugs, installation status |
...
Docs are ordered so you can follow the flow from overview â†’ features â†’ setup â†’ APIs â†’ behavior â†’ reference:

- [2.0 Features Implemented](2.0-FEATURES-IMPLEMENTED.md) â€” What the app does
- [3.0 Compatibility](3.0-COMPATIBILITY.md) â€” Device requirements
- [4.0 Device Installation](4.0-DEVICE-INSTALLATION.md) â€” Provisioning and installation
- [5.0 Device Registration](5.0-DEVICE-REGISTRATION.md) â€” Registration flow
- [6.0 APIs](6.0-APIS.md) â€” Backend endpoints reference
- [7.0 Device Heartbeat](7.0-DEVICE-HEARTBEAT.md) â€” Heartbeat mechanism
- [8.0 Hard Lock and Soft Lock](8.0-HARD-LOCK-AND-SOFT-LOCK.md) â€” Lock modes
- [9.0 Device Tamper](9.0-DEVICE-TAMPER.md) â€” Tamper detection and response
- [10.0 Local Databases](10.0-LOCAL-DATABASES.md) â€” Room and persistence
- [11.0 Device Logs and Bugs](11.0-DEVICE-LOGS-AND-BUGS.md) â€” Logging and bug reporting
- [12.0 Agent Update](12.0-AGENT-UPDATE.md) â€” Auto-update from GitHub
- [13.0 Services](13.0-SERVICES.md) â€” All configured Android services
- [14.0 Folder Structure](14.0-FOLDER-STRUCTURE.md) â€” Project layout
- [15.0 FRP](15.0-FRP.md) â€” Factory Reset Protection
- [16.0 Deactivation](16.0-DEACTIVATION.md) â€” Device Owner removal and deactivation
- [README](README.md) â€” Full documentation index and recommended reading order
